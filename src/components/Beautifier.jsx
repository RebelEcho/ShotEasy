                    ...
                    <div className="md:w-0 md:flex-1 overflow-auto select-none p-5">
                        <div className="min-w-full md:min-w-[600px] min-h-full flex items-center justify-center">
                            <div ref={boxRef} className={cn(
                                ...
                                {bgValue.includes('_img_') && <img src={`${backgroundConfig[bgValue]}&w=1200`} alt="截图背景预览" className="w-full h-full absolute z-0 object-cover object-center" />}
                                <Watermark
                                ...
                                >
                                    <div className="absolute inset-0 flex items-center justify-center z-10">
                                        ...
                                        >
                                            ...
                                            <p className="text-sm px-4">点击或将图片拖拽到此处<br/>或粘贴图片</p>
                                        </Dragger>}
                                        ...
                                        {(photoUrl && !modelFrame.includes(frame)) && <div className={cn(
                                            ...
                                            <div className="overflow-hidden w-full flex items-center" style={{
                                                ...
                                                <img src={photoUrl} alt="美化后的截图预览" className="w-full" />
                                            </div>
                                        </div>}
                                    </div>
                                </Watermark>
                    ...
                    <div className="bg-white flex flex-col gap-2 p-4 md:w-[340px] border-l border-l-gray-50 shadow-lg relative z-10">
                        ...
                        <div className="[&_label]:font-semibold [&_label]:text-sm">
                            <div className="flex justify-between items-center">
                                ...
                                >更多<Icon name="ChevronRight" style={{ marginLeft: 0 }} /></Button>
                            </div>
                            <div className="py-3">
                        ...
                        <div className="[&_label]:font-semibold [&_label]:text-sm flex justify-between items-center">
                            ...
                            <Select
                                ...
                                options={[
                                    { value: 'none', label: '无' },
                                    { value: 'light', label: '浅色玻璃' },
                                    { value: 'dark', label: '深色玻璃' },
                                    { value: 'macbookPro', label: 'Macbook Pro M3' },
                                    { value: 'iphonePro', label: 'iPhone 15 Pro' },
                                    { value: 'macosBarLight', label: 'macOS 浅色' },
                                    { value: 'macosBarDark', label: 'macOS 深色' },
                                    { value: 'windowsBarLight', label: 'Windows 浅色' },
                                    { value: 'windowsBarDark', label: 'Windows 深色' },
                                ]}
                            />
                        </div>
                        {modelFrame.includes(frame) &&
                            <div className="flex items-center justify-between text-xs">
                                ...
                                <div>
                                    <Radio.Group defaultValue={fit} onChange={(e) => setFit(e.target.value)} size="small">
                                        <Radio.Button value="contain" className="text-xs">包含</Radio.Button>
                                        <Radio.Button value="cover" className="text-xs">覆盖</Radio.Button>
                                        <Radio.Button value="fill" className="text-xs">填充</Radio.Button>
                                    </Radio.Group>
                                </div>
                            </div>
                        }
