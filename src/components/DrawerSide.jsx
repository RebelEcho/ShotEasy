        ...
        >
            <div className="flex flex-col gap-2 h-full overflow-hidden">
                ...
                <div className="h-0 flex-1 overflow-y-auto px-4 py-2">
                    <h4 className="text-sm font-bold py-2">图片颜色</h4>
                    {!photoUrl && <div className="text-xs p-1 text-center text-gray-400">✨ 从你的图片中提取颜色</div>}
                    {photoUrl && (
                        <>
                            <div className="flex gap-3 items-center mb-2">
                                <div className="overflow-hidden p-[1px] border" style={{width: `${realWidth}px`}}>
                                    <img src={photoUrl} alt="上传图片颜色预览" className="w-full" />
                                </div>
                    ...
                    <h4 className="text-sm font-bold pb-1 pt-2">渐变</h4>
