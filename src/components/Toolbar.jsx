    ...
    return (
        <div className="flex items-center">
            ...
            <div className="px-3 border-l flex gap-1 items-center">
                <ColorPicker size="small" presets={[{ label: '推荐', colors: ['#ffffff', '#444444', '#df4b26', '#1677ff', '#52C41A', '#FA8C16', '#FADB14', '#EB2F96', '#722ED1'] }]} value={annotateColor} onChange={onAnnotateChange} />
                <WidthDropdown defaultValue={annotateWidth} onClick={onWidthChange} />
            </div>
            <div className="px-3 border-l flex gap-1 items-center">
                <Tooltip placement="bottom" title="使用 WebRTC 截取屏幕">
                    <Button
                        type="text"
                        shape="circle"
