    ...
    let component = (
        <div className="text-center py-16">
            <Button className="[&_span]:align-middle" style={{
                width: '320px',
                height: '54px'
            }} size="large" type="primary" icon={<Icon name="Camera" size={25} />} loading={loading} onClick={toCapture}>截图</Button>
            <p className="text-slate-400 text-xs mt-2">* 如果找不到想要的窗口，请先滚动或最大化目标窗口后重试</p>
            <div className="pt-1">
                <UploadFile />
            </div>
        </div>
